...
# https://ligdigonzalez.com/portfolio/predecir-la-supervivencia-del-titanic-utilizando-python/
import numpy as np
import pandas as pd
...
url_test = 'http://proyecto.itsva.edu.mx/test.csv'
url_train = 'http://proyecto.itsva.edu.mx/train.csv'
df_test = pd.read_csv(url_test)
df_train = pd.read_csv(url_train)
#Se guardan los datos en un archivo para siempre tenerlos disponibles
dir_test = '/home/angel/Escritorio/titanic/test.csv'
dir_train = '/home/angel/Escritorio/titanic/train.csv'
